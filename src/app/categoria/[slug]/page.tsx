import { getCategories, getCategoryBySlug, getProducts } from '@/lib/firebase/db'
...
export default async function CategoryPage({ params, searchParams }: PageProps) {
  ...
  const sort =
    searchParamsResolved.sort === 'price_asc' || searchParamsResolved.sort === 'price_desc'
